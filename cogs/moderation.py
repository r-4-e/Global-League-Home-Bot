...
class ModerationCog(commands.Cog, name="Moderation"):
    ...
    async def unmute(
        ...
        if not muted_role_id:
            await interaction.response.send_message(
                embed=embeds.error("No Muted Role", "Muted role not configured."), ephemeral=False
            )
            return
    ...
    async def timeout(
        ...
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Failed", "I couldn't timeout that user."), ephemeral=False
            )
            return
    ...
    async def untimeout(
        ...
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Failed", "Could not remove timeout."), ephemeral=False
            )
            return
        case_id = await _create_and_log(
            self.bot, interaction.guild,
    ...
    async def kick(
        ...
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Failed", "I couldn't kick that user."), ephemeral=False
            )
            return
    ...
    async def ban(
        ...
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Failed", "I couldn't ban that user."), ephemeral=False
            )
            return
    ...
    async def unban(
        ...
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Invalid ID", "Provide a valid numeric user ID."), ephemeral=False
            )
            return
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Failed", "I couldn't unban that user."), ephemeral=False
            )
            return
    ...
    async def softban(
        ...
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Failed", "I couldn't softban that user."), ephemeral=False
            )
            return
    ...
    async def massban(
        ...
        await interaction.followup.send(embed=embeds.success("Mass Ban Complete", desc), ephemeral=False)
    ...
    async def masskick(
        ...
        if failed_list:
            desc += f"**Failed ({len(failed_list)}):** {', '.join(failed_list)}"
        await interaction.followup.send(embed=embeds.success("Mass Kick Complete", desc), ephemeral=False)
    ...
    async def clear(
        ...
        if not isinstance(channel, discord.TextChannel):
            await interaction.followup.send(embed=embeds.error("Invalid Channel", "Use this in a text channel."), ephemeral=False)
            return
        ...
        try:
            ...
            await interaction.followup.send(
                embed=embeds.error("Failed", "I can't delete messages here."), ephemeral=False
            )
            return
        ...
        await interaction.followup.send(
            embed=embeds.success("Cleared", f"Deleted **{len(deleted)}** messages."), ephemeral=False
        )
    ...
    async def slowmode(
        ...
        if not isinstance(target, discord.TextChannel):
            await interaction.response.send_message(
                embed=embeds.error("Invalid Channel", "Target must be a text channel."), ephemeral=False
            )
            return
        ...
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Failed", "I can't edit that channel."), ephemeral=False
            )
            return
        msg = f"Slowmode {'disabled' if seconds == 0 else f'set to {seconds}s'} in {target.mention}"
        await interaction.response.send_message(embed=embeds.success("Slowmode Updated", msg), ephemeral=False)
    ...
    async def lock(
        ...
        await interaction.response.send_message(
            embed=embeds.success("Channel Locked", f"{target.mention} is now locked."), ephemeral=False
        )
    ...
    async def unlock(
        ...
        await interaction.response.send_message(
            embed=embeds.success("Channel Unlocked", f"{target.mention} is now unlocked."), ephemeral=False
        )
    ...
    async def nick(
        ...
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Failed", "I can't change that user's nickname."), ephemeral=False
            )
            return
        action = f"Nickname changed: `{old}` → `{nickname or 'reset'}`"
        await interaction.response.send_message(embed=embeds.success("Nickname Updated", action), ephemeral=False)
    ...
    async def role_add(
        ...
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Failed", "I can't assign that role."), ephemeral=False
            )
            return
        await interaction.response.send_message(
            embed=embeds.success("Role Added", f"{role.mention} added to {user.mention}."), ephemeral=False
        )
    ...
    async def role_remove(
        ...
        try:
            ...
            await interaction.response.send_message(
                embed=embeds.error("Failed", "I can't remove that role."), ephemeral=False
            )
            return
        await interaction.response.send_message(
            embed=embeds.success("Role Removed", f"{role.mention} removed from {user.mention}."), ephemeral=False
        )
    ...
    async def cog_app_command_error(
        ...
        try:
            if interaction.response.is_done():
                await interaction.followup.send(embed=embeds.error("Error", msg), ephemeral=False)
            else:
                await interaction.response.send_message(embed=embeds.error("Error", msg), ephemeral=False)
        except Exception:
            pass
