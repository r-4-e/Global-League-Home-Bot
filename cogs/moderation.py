...
from utils.permissions import gate_hierarchy, gate_permission, gate_warn, gate_timeout_duration, BOT_OWNER_ID
...
class ModerationCog(commands.Cog, name="Moderation"):
    ...
    async def mute(self, ctx, user: discord.Member, duration: str = None, *, reason: str = None):
        ...
        if duration:
            ...
            if not await gate_timeout_duration(ctx, int(td.total_seconds())): return
