...
class ModerationCog(commands.Cog, name="Moderation"):
    ...
    note_group = app_commands.Group(
        name="note",
        description="Manage staff notes for a user.",
        guild_ids=[GUILD_ID],
    )
    ...
    @note_group.command(name="list", description="View all staff notes for a user.")
    ...
    async def note_list(
        ...
        for note in notes[:10]:  # Show latest 10
    ...
    @note_group.command(name="delete", description="Delete a staff note by its ID.")
